...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './timeslot.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIMESLOT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TIMESLOT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TIMESLOT actions', async () => {
      const arg = { id: 26281 };
    ...
    it('dispatches UPDATE_TIMESLOT actions', async () => {
      const arg = { id: 26281 };
    ...
    it('dispatches PARTIAL_UPDATE_TIMESLOT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TIMESLOT actions', async () => {
      const arg = 42666;
