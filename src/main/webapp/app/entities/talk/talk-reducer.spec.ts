...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './talk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TALK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TALK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TALK actions', async () => {
      const arg = { id: 14477 };
    ...
    it('dispatches UPDATE_TALK actions', async () => {
      const arg = { id: 14477 };
    ...
    it('dispatches PARTIAL_UPDATE_TALK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TALK actions', async () => {
      const arg = 42666;
