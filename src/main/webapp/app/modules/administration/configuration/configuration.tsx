...
export const ConfigurationPage = () => {
  ...
  return (
    <div>
      ...
      <span>Filter (nach Präfix)</span> <Input type="search" value={filter} onChange={changeFilter} name="search" id="search" />
      <label>Spring configuration</label>
      <Table className="table table-striped table-bordered table-responsive d-table">
        <thead>
          <tr>
            <th onClick={changeReversePrefix}>Präfix</th>
            <th onClick={changeReverseProperties}>Eigenschaften</th>
          </tr>
        </thead>
        <tbody>
