package de.xares.conference.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.xares.conference.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.xares.conference.repository.UserRepository.USERS_BY_EMAIL_CACHE);
